...
class ElevatedButtonWidget extends StatelessWidget{
  ...
  const ElevatedButtonWidget({super.key, required this.title, required this.onPressed, this.width=double.infinity, this.height=50, this.backgroundColor, this.hoverColor=Colors.blueGrey, this.foregroundColor});
