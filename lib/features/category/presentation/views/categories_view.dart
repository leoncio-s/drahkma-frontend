...
import 'package:drahkma/features/categories/domain/util/categories_model_sort.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    children: [
                      Tooltip(
                        ...
                        child: IconButton(
                          onPressed: () {
                            setState(() {
                              categories!.sort(CategoriesModelSort.asc);
                            });
                          },
                      ...
                      Tooltip(
                        ...
                        child: IconButton(
                          onPressed: () {
                            categories != null
                                ? setState(() {
                                    categories!.sort(CategoriesModelSort.desc);
                                  })
                                : null;
                          },
      ...
      floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            CategoriesModel? data = await Navigator.of(context).push(
            ...
            children: ListTile.divideTiles(
                    ...
                    tiles: categories!
                        .map((el) => ListTile(
                              ...
                              onTap: () async {
                                CategoriesModel? data = await Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CategoriesForm(category: el)));
                                if(data != null){
                                  _getData();
                                }
                              },
